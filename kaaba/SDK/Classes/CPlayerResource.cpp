...
bool CSPlayerResource::GetConnected(int idx) {
	static auto m_bConnected = Engine::g_PropManager.GetOffset(XorStr("DT_PlayerResource"), XorStr("m_bConnected "));
	return *(bool*)((uintptr_t)this + m_bConnected + idx );
}
