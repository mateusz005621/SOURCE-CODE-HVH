...
#pragma region Rage general group
	...
	config_option( float, anti_aim_yaw_slow_spin_speed, 1.0f );
	...
	config_option( int, anti_aim_fake_yaw, 0 ); // Existing: 0-Off, 1-Default, 2-Relative, 3-Jitter, 4-Rotate, 5-Random. New: 6-LBY Sync Jitter
...
#pragma region MISC group
	...
	config_option( float, clantag_animation_speed, 0.15f );
