...
// ÑÏÀÑÈÁÎ ÏÀÏÀØÀ( ÄÆÎÍ ÊÀĞÌÀÊ ) ÇÀ İÒÓ ÊÂÀÊÎÂÑÊÓŞ ÌÀÒÅÌÀÒÈÊÓ 20 ÂÅÊÀ ( ÍÓ ÒÓÒ ÍÅ ÑÏÈÇÄÈË ĞÅÀËÜÍÎ 20 ÂÅÊ )
...
//tibbzy is a fucking paster #greendot
matrix3x4_t matrix3x4_t::ConcatTransforms(matrix3x4_t in, matrix3x4_t in2) const {
	matrix3x4_t out;
	out[0][0] = in[0][0] * in2[0][0] + in[0][1] * in2[1][0] + in[0][2] * in2[2][0];
	out[0][1] = in[0][0] * in2[0][1] + in[0][1] * in2[1][1] + in[0][2] * in2[2][1];
	out[0][2] = in[0][0] * in2[0][2] + in[0][1] * in2[1][2] + in[0][2] * in2[2][2];
	out[0][3] = in[0][0] * in2[0][3] + in[0][1] * in2[1][3] + in[0][2] * in2[2][3] + in[0][3];

	out[1][0] = in[1][0] * in2[0][0] + in[1][1] * in2[1][0] + in[1][2] * in2[2][0];
	out[1][1] = in[1][0] * in2[0][1] + in[1][1] * in2[1][1] + in[1][2] * in2[2][1];
	out[1][2] = in[1][0] * in2[0][2] + in[1][1] * in2[1][2] + in[1][2] * in2[2][2];
	out[1][3] = in[1][0] * in2[0][3] + in[1][1] * in2[1][3] + in[1][2] * in2[2][3] + in[1][3];

	out[2][0] = in[2][0] * in2[0][0] + in[2][1] * in2[1][0] + in[2][2] * in2[2][0];
	out[2][1] = in[2][0] * in2[0][1] + in[2][1] * in2[1][1] + in[2][2] * in2[2][1];
	out[2][2] = in[2][0] * in2[0][2] + in[2][1] * in2[1][2] + in[2][2] * in2[2][2];
	out[2][3] = in[2][0] * in2[0][3] + in[2][1] * in2[1][3] + in[2][2] * in2[2][3] + in[2][3];
	return out;
}
