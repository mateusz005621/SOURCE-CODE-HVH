...
bool GUI::Controls::Label( const std::string &name, bool unsafe ) {
	...
	DrawPos.x += 20;
	Render::DirectX::Fonts::menu.draw_text( GUI::SplitStr( name, '#' )[ 0 ].data( ), DrawPos - Vector2D( 0, 5 ), ctx->disabled ? Color( 80, 80, 80 ) : ( unsafe ? Color( 180, 180, 100 ) : Color( 200, 200, 200 ) ), 4 );
	//GUI::ctx->disabled
